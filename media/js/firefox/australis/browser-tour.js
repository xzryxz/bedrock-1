...
;(function($, Mozilla) {
    ...
    */
    ...
    /*
     * Shows current tour step highlight item, based on the list of available targets
     */
    ...
    BrowserTour.prototype.startTour = function () {
        ...
        this.$tour.one('transitionend', this.onStartTour.bind(this));
     ...
     */
    BrowserTour.prototype.onStartTour = function (e) {
        if (e.originalEvent.propertyName === 'transform') {
            var $current = this.$tourList.find('li.current');
            var that = this;
            $current.find('h2').focus();
